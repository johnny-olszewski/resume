...
\vspace{-0.4mm}
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
        \item Develops and maintains features for over 3.5 million active users in the myAir app while migrating a legacy UIKit codebase to SwiftUI and prioritizing clean coding practices and meeting delivery timelines 
        \item Collaborates closely with product, UI/UX, Android, and back-end teams to ensure consistency with requirements for platform-specific implementation while addressing stakeholder feedback
...
\vspace{-0.4mm}
 \resumeHeadingSkillStart
  ...
  \resumeSubItem{DevOps \& Version Control:}
    {Git, GitHub, JIRA, Atlassian Suite}
